...
make # Compilamos
rm medidas_2.csv # Limpiamos el fichero de resultados
echo 'ID_PRUEBA,N,T_TOTAL' > medidas_2.csv # Cabecera del fichero
...
do
    ...
    do
        ...
        eval "./p2_apartado2.out $n $id_prueba" # Ejecutamos el primer experimento
    done
done