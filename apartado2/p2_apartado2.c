...
int main(int argc, char **argv)
{
    ...
    double **a, **b, **bTrasp, *c, **d, *e, f, tiempo, elem0, elem1, elem2, elem3, elem4, elem5, elem6, elem7, elem8, elem9, *lineaA, *lineaB0, *lineaB1, *lineaB2, *lineaB3, *lineaB4, *lineaB5, *lineaB6, *lineaB7, *lineaB8, *lineaB9, elemA, elemA2;
